...
require("oil").setup({
  ...
  keymaps = {
    ...
    ["<leader>ot"] = false, -- { "actions.select", opts = { tab = true }, desc = "Open the entry in new tab" },
    ...
    ["_"] = "actions.open_cwd",
    ["`"] = false, -- "actions.cd",
    ["~"] = false, -- { "actions.cd", opts = { scope = "tab" }, desc = ":tcd to the current oil directory", mode = "n" },
